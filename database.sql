...
insert  into `customerindustries`(`id`,`customerid`,`industryid`,`addedby`,`dateadded`,`deleted`,`datedeleted`,`deletedby`) values (1,9,4,5,'2022-01-06 09:51:37',0,NULL,NULL),(2,9,5,5,'2022-01-06 09:51:37',0,NULL,NULL);
...
insert  into `customers`(`customerid`,`customerno`,`customername`,`classificationid`,`telephone`,`email`,`physicaladdress`,`postaladdress`,`town`,`postalcode`,`lat`,`long`,`dateadded`,`addedby`,`deleted`,`datedeleted`,`deletedby`,`regdocid`,`regno`,`regdate`,`hasbranches`) values (2,'CST00001/2019','Richard Onyango',5,727709772,'akellorich@yahoo.com','Haile Sellasie Av, Nairobi CBD','52420','Nairobi','00200','-1.290970','36.825650','2021-12-20 12:19:16',2,0,NULL,NULL,1,'23657524',NULL,0),(4,'CST00002/2019','Makena Brenda',5,791404218,'makenaa.bk@yahoo.com','Haile Sellasie Av, Nairobi CBD','52420','Nairobi','00200','-1.290970','36.825650','2021-12-20 12:20:40',2,0,NULL,NULL,1,'37353934',NULL,0),(5,'CST00003/2019','The Technical University of Kenya',8,20123456,'info@tukenya.ac.ke','Haile Sellasie Avenue','52428','Nairobi','00200','-1.287540','36.814520','2022-01-05 11:02:45',2,0,NULL,NULL,1,'0000',NULL,0),(7,'CST00004/2019','University of Nairobi',8,201234578,'info@uon.ac.ke','Haile Sellasie Avenue','52428','Nairobi','00200','-1.287540','36.814520','2022-01-05 11:05:23',2,0,NULL,NULL,1,'0001',NULL,0),(8,'CST00005/2019','Jomo Kenyatta University',8,2037454,'info@jkuat.ac.ke','Thika Road, Near Juja','3872','Thika','401100','-1.287530','36.814750','2022-01-06 09:09:06',5,0,NULL,NULL,1,'475687645','2021-04-01',1),(9,'CST00006/2019','Maseno University',8,2147483647,'info@maseno.ac.ke','Maseno','38978','Kisumu','47600','-1.287530','36.814750','2022-01-06 09:51:37',5,0,NULL,NULL,1,'48976','2021-01-03',1);
...
insert  into `serials`(`id`,`description`,`prefix`,`currentno`,`suffix`) values (1,'customer no','CST',7,'2019');
...
insert  into `tempcustomerindustries`(`refno`,`industryid`) values ('99253',4),('99253',5);
...
insert  into `users`(`userid`,`username`,`password`,`firstname`,`lastname`,`gender`,`mobile`,`email`,`accountactive`,`systemadmin`,`addedby`,`dateadded`) values (2,'Admin','1c986a5f526fda89666cdb2a9547a436','System','Admin','Male',727709772,'akellorich@yahoo.com',1,1,NULL,NULL),(3,'richard','1c986a5f526fda89666cdb2a9547a436','Richard','Onyango','male',727709773,'akellorich@gmail.com',1,0,2,'2021-12-21 11:30:36'),(4,'makena','827ccb0eea8a706c4c34a16891f84e7b','Makena','Brenda','female',791404218,'makenaa.bk@gmail.com',1,0,2,'2021-12-21 11:36:45'),(5,'Matano','1c986a5f526fda89666cdb2a9547a436','Richard','Matano','male',725123456,'matano@yahoo.com',0,0,2,'2022-01-04 09:16:07');
...
BEGIN
	...
	COUNT(cb.customerid) AS branches
	FROM `customers` c
	...
	LEFT OUTER JOIN `customerbranches` cb ON cb.`customerid`=c.customerid
	WHERE `customername` LIKE CONCAT('%',$customername,'%')
	GROUP BY c.customerid,c.`customerno`,c.`customername`,c.`telephone`,c.`email`,c.`physicaladdress`,c.`postaladdress`,c.`town`,c.`postalcode`,c.`lat`,c.`long`
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_saveuser`($userid int, $username varchar(50),$userpassword varchar(50),$firstname varchar(50),$lastname varchar(50),
	$gender varchar(50),$mobile int, $email varchar(50),$accountactive boolean,$systemadmin boolean,$addedby int)
BEGIN
	if $userid=0 then
		insert into `users`(`username`,`password`,`firstname`,`lastname`,`gender`,`mobile`,`email`,`accountactive`,`systemadmin`,`addedby`,`dateadded`)
		values($username,$userpassword,$firstname,$lastname,$gender,$mobile,$email,$accountactive,$systemadmin,$addedby,now());
	else
		update `users` 
